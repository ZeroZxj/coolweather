...
import com.example.zxj.coolweather.gson.Forecast;
import com.example.zxj.coolweather.gson.Weather;
import com.example.zxj.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private ImageView   bingPicImg;         // bing背景图
    public DrawerLayout drawerLayout;
    public SwipeRefreshLayout swipeRefresh; // 下拉刷新布局
    private ScrollView weatherLayout;       // 最外层的滚动控件
    ...
    private TextView degreeText;            // 天气预报
    private TextView weatherInfoText;
    private LinearLayout forecastLayout;

    private TextView aqiText;               // 空气状况
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "http://www.guolin.tech/api/weather?cityid="+ weatherId + "&key=00546cb3c5d241de81af32d57f157ea4";
